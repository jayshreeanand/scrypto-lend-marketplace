...
let A = class extends LitElement {
  constructor() {
...
let j = class extends LitElement {
  constructor() {
...
let y = class extends LitElement {
  constructor() {
    ...
    }, this.dAppName = "", this.personaLabel = "", this.subscriptions = new C(), this.fontGoogleApiHref = "https://fonts.googleapis.com/css?family=IBM+Plex+Sans:400,600", this.injectFontCSS(), this.subscriptions.add(R(window, "click").pipe(ot(() => this.showPopover), ot((t) => !this.contains(t.target)), ve(() => this.showPopover = false)).subscribe());
  }
  connectedCallback() {
    super.connectedCallback(), this.dispatchEvent(new CustomEvent("onRender", {
      bubbles: true,
      composed: true
    }));
  }
  ...
  shouldSkipFontInjection() {
    return !!document.head.querySelector(`link[href|="${this.fontGoogleApiHref}"]`) || document.fonts.check("16px IBM Plex Sans");
  }
  injectFontCSS() {
  ...
  togglePopover() {
    this.showPopover = !this.showPopover, this.showPopover && this.dispatchEvent(new CustomEvent("onShowPopover", {
      bubbles: true,
      composed: true
    }));
  }
  ...
  requestItemsTemplate() {
    return this.requestItems.length === 0 ? "" : html`<div class="wrapper request-item-list">
      ${this.requestItems.slice(-3).reverse().map((t) => html`<div class="wrapper request-item">
              <radix-request-item
                .item=${t}
                transactionExplorerBaseUrl="${this.explorer.baseUrl}${this.explorer.transactionPath}"
                @onCancel=${() => {
      this.dispatchEvent(new CustomEvent("onCancelRequestItem", {
        detail: {id: t.id},
        bubbles: true,
        composed: true
      }));
  ...
  accountListTemplate() {
    return html`<div class="wrapper account-list">
      ${this.accounts.map((t) => html`<div class="wrapper account gradient-${t.appearanceId}">
...
export { y as ConnectButton, B as RequestItemType, Le as RequestStatus };
