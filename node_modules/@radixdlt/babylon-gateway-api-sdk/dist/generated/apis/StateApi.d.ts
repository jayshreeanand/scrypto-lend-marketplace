...
export declare class StateApi extends runtime.BaseAPI {
     ...
     */
    nonFungibleDetailsRaw(requestParameters: NonFungibleDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StateNonFungibleDetailsResponse>>;
    /**
     * Returns data associated with a given non-fungible ID of a given non-fungible resource.
     * Get Non-Fungible Details
     */
    nonFungibleDetails(requestParameters: NonFungibleDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StateNonFungibleDetailsResponse>;
    /**
